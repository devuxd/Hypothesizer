...
function AddTodo({ addTodo }) {
  ...
  return (
    <div className="w-full center" id="addTodo">
      {/* BUG HERE */}
      <form onPress={handleSubmit} className="bg-white shadow-md rounded px-8 pt-4 pb-8 mb-4">
        ...
        <div style={{ textAlign: 'center' }}>
          <button type="button" className="bg-blue-500 text-white font-bold py-2 px-4 rounded transition duration-500 ease-in-out bg-blue-500 hover:bg-green-500 transform hover:-translate-y-1 hover:scale-110 ...">Add</button>
        </div>
      </form>
    </div>
  )
