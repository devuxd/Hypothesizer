  ...
  if (!editing)
    return (
      <div id="todo" className="todo block text--700 text-center bg-gray-200 hover:bg-gray-400 px-4 py-2 mt-2" style={{ backgroundColor: todo.completed ? "#bdffcf" : "" }}>
        ...
        <div id="NotTodo">
          {/* BUG IS HERE */}
          {todo.completed ? <button onClick={() => unCompleteTodo(index)} style={{ backgroundColor: styles.style === 'red' ? "red" : "blue" }}> Pending </button>
            : <button onClick={() => completeTodo(index)} style={{ backgroundColor: styles.style === 'red' ? "red" : "blue" }}> Complete </button>}
