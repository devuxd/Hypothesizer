    ...
    <div className="w-full center" id="addTodo">
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-4 pb-8 mb-4">
        ...
        <div style={{ textAlign: 'center' }}>
          {/* BUG IS HERE */}
          <button type="button" className="bg-blue-500 text-white font-bold py-2 px-4 rounded transition duration-500 ease-in-out bg-blue-500 hover:bg-purple-500 transform hover:-translate-y-1 hover:scale-110 ...">Save</button>
        </div>
      </form>
    </div>
  )
